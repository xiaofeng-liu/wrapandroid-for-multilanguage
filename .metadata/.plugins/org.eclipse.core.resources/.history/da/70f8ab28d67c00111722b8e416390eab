	...
	static public boolean Init(StarServiceClass In_Service,StarSrvGroupClass In_SrvGroup,boolean In_DumpInformationFlag){
        ...
        Service._GetObject("GradientDrawableClass")._Assign(new StarObjectClass(){
        	...
        	public int  getChangingConfigurations(StarObjectClass self){
        		StarCLEGradientDrawable gradientdrawable = (StarCLEGradientDrawable)WrapAndroidClass.GetAndroidObject(self,"AndroidObject");
        		if( gradientdrawable != null && gradientdrawable.GetAndroidObject() != null )
        			return ((GradientDrawable)gradientdrawable.GetAndroidObject()).getChangingConfigurations();
        		return 0;
        	} 
        	/**
        	 * <div class="memproto">
        	...
        	public int  getIntrinsicHeight(StarObjectClass self){
        		StarCLEGradientDrawable gradientdrawable = (StarCLEGradientDrawable)WrapAndroidClass.GetAndroidObject(self,"AndroidObject");
        		if( gradientdrawable != null && gradientdrawable.GetAndroidObject() != null )
        			return ((GradientDrawable)gradientdrawable.GetAndroidObject()).getIntrinsicHeight();
        		return 0;
        	} 
        	/**
        	 * <div class="memproto">
        	...
        	public int  getIntrinsicWidth(StarObjectClass self){
        		StarCLEGradientDrawable gradientdrawable = (StarCLEGradientDrawable)WrapAndroidClass.GetAndroidObject(self,"AndroidObject");
        		if( gradientdrawable != null && gradientdrawable.GetAndroidObject() != null )
        			return ((GradientDrawable)gradientdrawable.GetAndroidObject()).getIntrinsicWidth();
        		return 0;
        	}  
        	/**
        	 * <div class="memproto">
        	...
        	public int  getOpacity(StarObjectClass self){
        		StarCLEGradientDrawable gradientdrawable = (StarCLEGradientDrawable)WrapAndroidClass.GetAndroidObject(self,"AndroidObject");
        		if( gradientdrawable != null && gradientdrawable.GetAndroidObject() != null )
        			return ((GradientDrawable)gradientdrawable.GetAndroidObject()).getOpacity();
        		return 0;
        	}   
        	/**
        	 * <div class="memproto">
        	...
        	public boolean  getPadding(StarObjectClass self,StarObjectClass padding){
        		...
        		if( gradientdrawable != null && gradientdrawable.GetAndroidObject() != null ){
        			...
        			boolean Result = ((GradientDrawable)gradientdrawable.GetAndroidObject()).getPadding(rect);
        			if( Result == false )
        				return false;
