...
public class RadioButtonClass{
	...
	static public boolean Init(StarServiceClass In_Service,StarSrvGroupClass In_SrvGroup,boolean In_DumpInformationFlag){
		...
		class StarCLERadioButton extends RadioButton implements BasicAndroidInterface{
			private BasicAndroidClass BasicAndroidObject;   
			private List<Object> RefList;
			public StarCLERadioButton(Context ctx,StarObjectClass In_Object){
				super(ctx);
        ...
        Service._GetObject("RadioButtonClass")._Assign(new StarObjectClass(){
        	...
        	public void onCreateAndroid( StarObjectClass self ){
        		...
        		StarCLERadioButton radiobuton = new StarCLERadioButton((Activity)WrapAndroidClass.GetAndroidObject(activity,"AndroidObject"),self);
        		WrapAndroidClass.SetAndroidObject(self,"AndroidObject",(Object)radiobuton);    
        		if( parent != null ){
        			if( activity == parent ){
