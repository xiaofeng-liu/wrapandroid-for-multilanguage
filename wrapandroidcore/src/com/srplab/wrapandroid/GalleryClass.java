...
public class GalleryClass{
	...
	static public boolean Init(StarServiceClass In_Service,StarSrvGroupClass In_SrvGroup,boolean In_DumpInformationFlag){
        ...
        Service._GetObject("GalleryClass")._Assign(new StarObjectClass(){
        	 ...
        	 * <div class="memproto">
        	 *   <table class="memname">
        	 *     <tr><td class="memname">public void  setCallbackDuringFling(StarObjectClass self,boolean shouldCallback)</td></tr>
        	 *   </table>
        	 * </div>  
        	 */
        	public void  setCallbackDuringFling(StarObjectClass self,boolean shouldCallback){
        		StarCLEGallery gallery = (StarCLEGallery)WrapAndroidClass.GetAndroidObject(self,"AndroidObject");
        		if( gallery != null )
        			gallery.setCallbackDuringFling(shouldCallback);
        		return;        		
        	} 
        	/**
        	 * <div class="memproto">
        	...
        	public void  setGravity(StarObjectClass self,int gravity){
        		StarCLEGallery gallery = (StarCLEGallery)WrapAndroidClass.GetAndroidObject(self,"AndroidObject");
        		if( gallery != null )
        			gallery.setGravity(gravity);
        		return;        		
        	}  
        	/**
        	 * <div class="memproto">
        	 *   <table class="memname">
        	 *     <tr><td class="memname">public void  setSpacing(StarObjectClass self,int spacing)</td></tr>
        	 *   </table>
        	 * </div>  
        	 */
        	 ...
        	 * <div class="memproto">
        	 *   <table class="memname">
        	 *     <tr><td class="memname">public void  setUnselectedAlpha(StarObjectClass self,float unselectedAlpha)</td></tr>
        	 *   </table>
        	 * </div>  
        	 */
        	public void  setUnselectedAlpha(StarObjectClass self,float unselectedAlpha){
        		StarCLEGallery gallery = (StarCLEGallery)WrapAndroidClass.GetAndroidObject(self,"AndroidObject");
        		if( gallery != null )
        			gallery.setUnselectedAlpha(unselectedAlpha);
        		return;        		
        	} 
        	/**
        	 * <div class="memproto">
        	 *   <table class="memname">
        	 *     <tr><td class="memname">public boolean  showContextMenu(StarObjectClass self)</td></tr>
        	 *   </table>
        	 * </div>  
        	 */
        	public boolean  showContextMenu(StarObjectClass self){
        		StarCLEGallery gallery = (StarCLEGallery)WrapAndroidClass.GetAndroidObject(self,"AndroidObject");
        		if( gallery != null )
        			return gallery.showContextMenu();
        		return false;        		
        	}         	
        });                
