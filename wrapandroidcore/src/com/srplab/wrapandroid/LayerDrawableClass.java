        ...
        Service._GetObject("LayerDrawableClass")._Assign(new StarObjectClass(){
        	...
        	public boolean Init(StarObjectClass self,StarParaPkgClass layers){
        		...
        		if( layerdrawable != null ){
        			...
        			for( int i=0; i < number ;i ++ ){
        				layerdrawable.AddRef(starobject[i]);
        	 ...
        	 * <div class="memproto">
        	 *   <table class="memname">
        	 *     <tr><td class="memname">public boolean  setDrawableByLayerId(StarObjectClass self,int id, StarObjectClass who) </td></tr>
        	 *   </table>
        	 * </div>
        	 */        	
        	public boolean  setDrawableByLayerId(StarObjectClass self,int id, StarObjectClass who){
        		StarCLELayerDrawable layerdrawable = (StarCLELayerDrawable)WrapAndroidClass.GetAndroidObject(self,"AndroidObject");
        		if( layerdrawable != null && layerdrawable.GetAndroidObject() != null ){
        			BasicAndroidInterface androidinterface = (BasicAndroidInterface)WrapAndroidClass.GetAndroidObject(who,"AndroidObject");
        			Drawable drawable = (Drawable)androidinterface.GetAndroidObject();
        			return ((LayerDrawable)layerdrawable.GetAndroidObject()).setDrawableByLayerId(id,drawable);
        		}
        		return false;
        	}  
        	/**
        	 * <div class="memproto">
        	 *   <table class="memname">
        	 *     <tr><td class="memname">public void  setId(StarObjectClass self,int index, int id) </td></tr>
        	 *   </table>
        	 * </div>
        	 */
        	public void  setId(StarObjectClass self,int index, int id){
        		StarCLELayerDrawable layerdrawable = (StarCLELayerDrawable)WrapAndroidClass.GetAndroidObject(self,"AndroidObject");
        		if( layerdrawable != null && layerdrawable.GetAndroidObject() != null )
        			((LayerDrawable)layerdrawable.GetAndroidObject()).setId(index,id);
        		return;
        	} 
        	/**
        	 * <div class="memproto">
        	 *   <table class="memname">
        	 *     <tr><td class="memname">public void  setLayerInset(StarObjectClass self,int index, int l, int t, int r, int b) </td></tr>
        	 *   </table>
        	 * </div>
        	 */
        	public void  setLayerInset(StarObjectClass self,int index, int l, int t, int r, int b){
        		StarCLELayerDrawable layerdrawable = (StarCLELayerDrawable)WrapAndroidClass.GetAndroidObject(self,"AndroidObject");
        		if( layerdrawable != null && layerdrawable.GetAndroidObject() != null )
        			((LayerDrawable)layerdrawable.GetAndroidObject()).setLayerInset(index,l,t,r,b);
        		return;
        	}   
        	/**
        	 * <div class="memproto">
        	...
        	public boolean  setVisible(StarObjectClass self,boolean visible, boolean restart){
        		StarCLELayerDrawable layerdrawable = (StarCLELayerDrawable)WrapAndroidClass.GetAndroidObject(self,"AndroidObject");
        		if( layerdrawable != null && layerdrawable.GetAndroidObject() != null )
        			return ((LayerDrawable)layerdrawable.GetAndroidObject()).setVisible(visible,restart);
        		return false;
        	}          	
        });    
