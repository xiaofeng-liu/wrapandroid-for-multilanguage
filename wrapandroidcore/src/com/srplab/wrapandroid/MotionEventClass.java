...
public class MotionEventClass{
	...
	static public boolean Init(StarServiceClass In_Service,StarSrvGroupClass In_SrvGroup,boolean In_DumpInformationFlag){
        ...
        Service._GetObject("MotionEventClass")._Assign(new StarObjectClass(){
        	 ...
        	 * <div class="memproto">
        	 *   <table class="memname">
        	 *     <tr><td class="memname">public int  getAction(StarObjectClass self) </td></tr>
        	 *   </table>
        	 * </div>
        	 */
        	 ...
        	 * <div class="memproto">
        	 *   <table class="memname">
        	 *     <tr><td class="memname">public int  getDeviceId(StarObjectClass self) </td></tr>
        	 *   </table>
        	 * </div>
        	 */
        	public int  getDeviceId(StarObjectClass self){
        		...
        		if( motionevent == null || motionevent.motionevent == null )
        			return 0;
        		return motionevent.motionevent.getDeviceId();
        	}  
        	/**
        	 * <div class="memproto">
        	 *   <table class="memname">
        	 *     <tr><td class="memname">public long  getDownTime(StarObjectClass self) </td></tr>
        	 *   </table>
        	 * </div>
        	 */
        	public long  getDownTime(StarObjectClass self){
        		...
        		if( motionevent == null || motionevent.motionevent == null )
        			return 0;
        		return motionevent.motionevent.getDownTime();
        	}  
        	/**
        	 * <div class="memproto">
        	 *   <table class="memname">
        	 *     <tr><td class="memname">public int  getEdgeFlags(StarObjectClass self) </td></tr>
        	 *   </table>
        	 * </div>
        	 */
        	public int  getEdgeFlags(StarObjectClass self){
        		...
        		if( motionevent == null || motionevent.motionevent == null )
        			return 0;
        		return motionevent.motionevent.getEdgeFlags();
        	}  
        	/**
        	 * <div class="memproto">
        	 *   <table class="memname">
        	 *     <tr><td class="memname">public long  getEventTime(StarObjectClass self) </td></tr>
        	 *   </table>
        	 * </div>
        	 */
        	public long  getEventTime(StarObjectClass self){
        		...
        		if( motionevent == null || motionevent.motionevent == null )
        			return 0;
        		return motionevent.motionevent.getEventTime();
        	}  
        	/**
        	 * <div class="memproto">
        	 *   <table class="memname">
