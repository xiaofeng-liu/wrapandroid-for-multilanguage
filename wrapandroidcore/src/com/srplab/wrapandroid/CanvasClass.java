...
public class CanvasClass{
	...
	static public boolean Init(StarServiceClass In_Service,StarSrvGroupClass In_SrvGroup,boolean In_DumpInformationFlag){
        ...
        Service._GetObject("CanvasClass")._Assign(new StarObjectClass(){
        	 ...
        	 * <div class="memproto">
        	 *   <table class="memname">
        	 *     <tr><td class="memname">public void  init(StarObjectClass self,StarObjectClass bitmap) </td></tr>
        	 *   </table>
        	 * </div>
        	 * @param 
        	 */         	
        	public boolean  init(StarObjectClass self,StarObjectClass bitmap){
        		StarCLECanvas canvas = (StarCLECanvas)WrapAndroidClass.GetAndroidObject(self,"AndroidObject");
        		if( canvas != null && canvas.GetAndroidObject() != null && bitmap != null ){
        			BasicAndroidInterface androidinterface = (BasicAndroidInterface)WrapAndroidClass.GetAndroidObject(bitmap,"AndroidObject");
        			canvas.SetAndroidObject(new Canvas((Bitmap)androidinterface.GetAndroidObject()));
        			canvas.AddRef(androidinterface);
        			bitmap._LockGC();
        			bitmap._Call("decAndroidRef");  // release with parent        			
        			return true;
        		}
        		return false;
        	}         	
        	...
        	public void  drawArc(StarObjectClass self,float left,float top,float right,float bottom, float startAngle, float sweepAngle, boolean useCenter, StarObjectClass paint){
        		...
        		if( canvas != null && canvas.GetAndroidObject() != null )
        			((Canvas)canvas.GetAndroidObject()).drawArc(new RectF(left,top,right,bottom), startAngle, sweepAngle, useCenter, (Paint)star_paint.GetAndroidObject());
        	} 
        	/**
        	 * <div class="memproto">
        	 *   <table class="memname">
        	...
        	public void  drawBitmap(StarObjectClass self,StarObjectClass bitmap, float left, float top, StarObjectClass paint){
        		...
        		if( canvas != null  && canvas.GetAndroidObject() != null && android_bitmap != null && android_bitmap.bitmap != null )
        			((Canvas)canvas.GetAndroidObject()).drawBitmap(android_bitmap.bitmap,left,top,(Paint)star_paint.GetAndroidObject());
        	}         	
        	/**
        	 * <div class="memproto">
        	 *   <table class="memname">
...
//        			((Canvas)canvas.GetAndroidObject()).drawBitmap(a,r,g,b);
        	...
        	public void  drawCircle(StarObjectClass self,float cx, float cy, float radius, StarObjectClass paint){
        		...
        		StarCLEPaint star_paint = (StarCLEPaint)WrapAndroidClass.GetAndroidObject(paint,"AndroidObject");
        		if( canvas != null && canvas.GetAndroidObject() != null )
        			((Canvas)canvas.GetAndroidObject()).drawCircle(cx,cy,radius,(Paint)star_paint.GetAndroidObject());
        	} 
        	/**
        	 * <div class="memproto">
        	 *   <table class="memname">
        	...
        	public void  drawLine(StarObjectClass self,float startX, float startY, float stopX, float stopY, StarObjectClass paint){
        		...
        		StarCLEPaint star_paint = (StarCLEPaint)WrapAndroidClass.GetAndroidObject(paint,"AndroidObject");
        		if( canvas != null && canvas.GetAndroidObject() != null )
        			((Canvas)canvas.GetAndroidObject()).drawLine(startX,startY,stopX,stopY,(Paint)star_paint.GetAndroidObject());
        	} 
        	/**
        	 * <div class="memproto">
        	 *   <table class="memname">
        	...
        	public void  drawOval(StarObjectClass self,float left,float top,float right,float bottom, StarObjectClass paint){
        		...
        		StarCLEPaint star_paint = (StarCLEPaint)WrapAndroidClass.GetAndroidObject(paint,"AndroidObject");
        		if( canvas != null && canvas.GetAndroidObject() != null )
        			((Canvas)canvas.GetAndroidObject()).drawOval(new RectF(left,top,right,bottom),(Paint)star_paint.GetAndroidObject());
        	} 
        	/**
        	 * <div class="memproto">
        	 *   <table class="memname">
        	...
        	public void  drawPaint(StarObjectClass self,StarObjectClass paint){
        		...
        		StarCLEPaint star_paint = (StarCLEPaint)WrapAndroidClass.GetAndroidObject(paint,"AndroidObject");
        		if( canvas != null && canvas.GetAndroidObject() != null )
        			((Canvas)canvas.GetAndroidObject()).drawPaint((Paint)star_paint.GetAndroidObject());
        	} 
        	/**
        	 * <div class="memproto">
        	 *   <table class="memname">
        	...
        	public void  drawPath(StarObjectClass self,StarObjectClass path, StarObjectClass paint){
        		...
        		StarCLEPaint star_paint = (StarCLEPaint)WrapAndroidClass.GetAndroidObject(paint,"AndroidObject");
        		if( canvas != null && canvas.GetAndroidObject() != null )
        			((Canvas)canvas.GetAndroidObject()).drawPath((Path)star_path.GetAndroidObject(),(Paint)star_paint.GetAndroidObject());
        	} 
        	/**
        	 * <div class="memproto">
        	 *   <table class="memname">
        	...
        	public void  drawPoint(StarObjectClass self,float x, float y, StarObjectClass paint){
        		...
        		StarCLEPaint star_paint = (StarCLEPaint)WrapAndroidClass.GetAndroidObject(paint,"AndroidObject");
        		if( canvas != null && canvas.GetAndroidObject() != null )
        			((Canvas)canvas.GetAndroidObject()).drawPoint(x,y,(Paint)star_paint.GetAndroidObject());
        	} 
        	/**
        	 * <div class="memproto">
        	 *   <table class="memname">
        	...
        	public void  drawRect(StarObjectClass self,float left, float top, float right, float bottom, StarObjectClass paint){
        		...
        		StarCLEPaint star_paint = (StarCLEPaint)WrapAndroidClass.GetAndroidObject(paint,"AndroidObject");
        		if( canvas != null && canvas.GetAndroidObject() != null )
        			((Canvas)canvas.GetAndroidObject()).drawRect(left,top,right,bottom,(Paint)star_paint.GetAndroidObject());
        	} 
        	/**
        	 * <div class="memproto">
        	 *   <table class="memname">
        	...
        	public void  drawRoundRect(StarObjectClass self,float left,float top,float right,float bottom, float rx, float ry, StarObjectClass paint){
        		...
        		StarCLEPaint star_paint = (StarCLEPaint)WrapAndroidClass.GetAndroidObject(paint,"AndroidObject");
        		if( canvas != null && canvas.GetAndroidObject() != null )
        			((Canvas)canvas.GetAndroidObject()).drawRoundRect(new RectF(left,top,right,bottom),rx,ry,(Paint)star_paint.GetAndroidObject());
        	} 
        	/**
        	 * <div class="memproto">
        	 *   <table class="memname">
        	...
        	public void  drawText(StarObjectClass self,String text, float x, float y, StarObjectClass paint){
        		...
        		StarCLEPaint star_paint = (StarCLEPaint)WrapAndroidClass.GetAndroidObject(paint,"AndroidObject");
        		if( canvas != null && canvas.GetAndroidObject() != null )
        			((Canvas)canvas.GetAndroidObject()).drawText(text,x,y,(Paint)star_paint.GetAndroidObject());
        	} 
        	/**
        	 * <div class="memproto">
        	 *   <table class="memname">
        	...
        	public void  drawTextOnPath(StarObjectClass self,String text, StarObjectClass path, float hOffset, float vOffset, StarObjectClass paint){
        		...
        		StarCLEPaint star_paint = (StarCLEPaint)WrapAndroidClass.GetAndroidObject(paint,"AndroidObject");
        		if( canvas != null && canvas.GetAndroidObject() != null )
        			((Canvas)canvas.GetAndroidObject()).drawTextOnPath(text,(Path)star_path.GetAndroidObject(),hOffset,vOffset,(Paint)star_paint.GetAndroidObject());
        	} 
        	/**
        	 * <div class="memproto">
        	 *   <table class="memname">
