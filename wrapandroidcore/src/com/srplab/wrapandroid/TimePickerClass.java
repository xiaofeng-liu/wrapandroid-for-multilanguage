...
public class TimePickerClass{
	...
	static public boolean Init(StarServiceClass In_Service,StarSrvGroupClass In_SrvGroup,boolean In_DumpInformationFlag){
		...
		WrapAndroidClass.DumpInformation(SrvGroup, DumpInformationFlag, "init TimePickerClass");

		class StarCLETimePicker extends TimePicker implements BasicAndroidInterface{
			private BasicAndroidClass BasicAndroidObject; 
			private List<Object> RefList;
			public StarCLETimePicker(Context ctx,StarObjectClass In_Object){
				super(ctx);
			...
			public void SetAndroidObject(Object object){SrvGroup._PrintError(1, "TimePickerClass not support SetAndroidObject" );}
        ...
        /* TimePickerClass Body */
        Service._GetObject("TimePickerClass")._Assign(new StarObjectClass(){
        	/* _OnCreate Event */
