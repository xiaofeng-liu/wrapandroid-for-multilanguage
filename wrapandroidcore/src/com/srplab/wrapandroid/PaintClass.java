...
public class PaintClass{
	...
	static public boolean Init(StarServiceClass In_Service,StarSrvGroupClass In_SrvGroup,boolean In_DumpInformationFlag){
        ...
        Service._GetObject("PaintClass")._Assign(new StarObjectClass(){
        	 ...
        	 * <div class="memproto">
        	 *   <table class="memname">
        	 *     <tr><td class="memname">ublic void  setTypeface(StarObjectClass self,StarObjectClass typeface) </td></tr>
        	 *   </table>
        	 * </div>
        	 * @param typeface may be null
        	 */        	
        	public void  setTypeface(StarObjectClass self,StarObjectClass typeface){
        		StarCLEPaint paint = (StarCLEPaint)WrapAndroidClass.GetAndroidObject(self,"AndroidObject");
        		if( paint != null && paint.GetAndroidObject() != null ){
        			if( typeface == null )
        				((Paint)paint.GetAndroidObject()).setTypeface(null);
        			else{
        				BasicAndroidInterface androidinterface = (BasicAndroidInterface)WrapAndroidClass.GetAndroidObject(typeface,"AndroidObject");
        				((Paint)paint.GetAndroidObject()).setTypeface((Typeface)androidinterface.GetAndroidObject());
        			}
        		}
        	}        	
        	/**
