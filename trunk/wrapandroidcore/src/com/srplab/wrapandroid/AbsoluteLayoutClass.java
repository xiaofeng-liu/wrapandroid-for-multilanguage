...
public class AbsoluteLayoutClass{
	/**
	...
	static public boolean Init(StarServiceClass In_Service,StarSrvGroupClass In_SrvGroup,boolean In_DumpInformationFlag){
		...
		WrapAndroidClass.DumpInformation(SrvGroup, DumpInformationFlag, "init AbsoluteLayoutClass");

		class StarCLEAbsoluteLayout extends AbsoluteLayout implements BasicAndroidInterface{
			private BasicAndroidClass BasicAndroidObject;  
			private List<Object> RefList;
			public StarCLEAbsoluteLayout(Context ctx,StarObjectClass In_Object){
				super(ctx);
			...
			public void SetAndroidObject(Object object){SrvGroup._PrintError(1, "AbsoluteLayoutClass not support SetAndroidObject" );}
        ...
        Service._GetObject("AbsoluteLayoutClass")._Assign(new StarObjectClass(){
        	...
        	public void onCreateAndroid( StarObjectClass self ){
        		...
        		StarCLEAbsoluteLayout layout = new StarCLEAbsoluteLayout((Activity)WrapAndroidClass.GetAndroidObject(activity,"AndroidObject"),self);
