...
public class OvalShapeClass{
	...
	static public boolean Init(StarServiceClass In_Service,StarSrvGroupClass In_SrvGroup,boolean In_DumpInformationFlag){
        ...
        /* OvalShapeClass Body */
        Service._GetObject("OvalShapeClass")._Assign(new StarObjectClass(){
        	/* onCreateAndroid function */
        	public void onCreateAndroid( StarObjectClass self ){
        		StarObjectClass parent = (StarObjectClass)self._Get("_Parent");
        		StarObjectClass activity = (StarObjectClass)self._Call("getActivity");        		
        		StarCLEOvalShape ovalshape = new StarCLEOvalShape((Activity)WrapAndroidClass.GetAndroidObject(activity,"AndroidObject"),self);        		
        	...
        	public void  draw(StarObjectClass self,StarObjectClass canvas,StarObjectClass paint){
        		StarCLEOvalShape ovalshape = (StarCLEOvalShape)WrapAndroidClass.GetAndroidObject(self,"AndroidObject");
        		...
        		if( ovalshape != null && ovalshape.GetAndroidObject() != null ){
            		if( paint != null ){
            			...
            			((RectShape)ovalshape.GetAndroidObject()).draw((Canvas)star_canvas.GetAndroidObject(),(Paint)star_paint.GetAndroidObject());
            		}else
            			((RectShape)ovalshape.GetAndroidObject()).draw((Canvas)star_canvas.GetAndroidObject(),null);
        		}
        	}	
        });    
