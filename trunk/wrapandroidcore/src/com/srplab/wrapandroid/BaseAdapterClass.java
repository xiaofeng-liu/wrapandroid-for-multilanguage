...
public class BaseAdapterClass{
	...
	static public boolean Init(StarServiceClass In_Service,StarSrvGroupClass In_SrvGroup,boolean In_DumpInformationFlag){
		...
		WrapAndroidClass.DumpInformation(SrvGroup, DumpInformationFlag, "init BaseAdapterClass");

		class StarCLEBaseAdapter extends BaseAdapter implements BasicAndroidInterface{
			private BasicAndroidClass BasicAndroidObject;
			private List<Object> RefList;
			public BasicAndroidClass getBasicAndroid(){return BasicAndroidObject;};			
			public Object GetAndroidObject(){return this;}
			public void SetAndroidObject(Object object){SrvGroup._PrintError(1, "BaseAdapterClass not support SetAndroidObject" );}
			public void AddRef(Object object){RefList.add(object);}
			public void DelRef(Object object){RefList.remove(object);}
			public StarCLEBaseAdapter(Context ctx,StarObjectClass In_Object){
				super();
        ...
        /* BaseAdapterClass Body */
        Service._GetObject("BaseAdapterClass")._Assign(new StarObjectClass(){
        	/* _OnCreate Event */
        	...
        	public void onCreateAndroid( StarObjectClass self ){
        		...
        		StarCLEBaseAdapter view = new StarCLEBaseAdapter((Activity)WrapAndroidClass.GetAndroidObject(activity,"AndroidObject"),self);        		
