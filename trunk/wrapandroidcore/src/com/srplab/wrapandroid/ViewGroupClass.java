	...
	static public boolean Init(StarServiceClass In_Service,StarSrvGroupClass In_SrvGroup,boolean In_DumpInformationFlag){
        ...
        Service._GetObject("ViewGroupClass")._Assign(new StarObjectClass(){       	
        	...
        	public void onSuperMeasure(StarObjectClass self,int widthMeasureSpec, int heightMeasureSpec){
        		StarCLEViewGroup viewgroup = (StarCLEViewGroup)WrapAndroidClass.GetAndroidObject(self,"AndroidObject");
        		if( viewgroup != null )
        			viewgroup.onSuperMeasure(widthMeasureSpec, heightMeasureSpec);
        	}        	
        	/**
        	 * <div class="memproto">
        	 *   <table class="memname">
        	...
        	public void onSuperSizeChanged(StarObjectClass self,int w, int h, int oldw, int oldh){
        		StarCLEViewGroup viewgroup = (StarCLEViewGroup)WrapAndroidClass.GetAndroidObject(self,"AndroidObject");
        		if( viewgroup != null )
        			viewgroup.onSuperSizeChanged(w, h, oldw, oldh);
        	}        	
        	/**
        	 * <div class="memproto">
        	 *   <table class="memname">
        	...
        	public void  setMeasuredDimension(StarObjectClass self,int measuredWidth, int measuredHeight)  {
        		StarCLEViewGroup viewgroup = (StarCLEViewGroup)WrapAndroidClass.GetAndroidObject(self,"AndroidObject");
        		if( viewgroup != null )
        			viewgroup._setMeasuredDimension(measuredWidth,measuredHeight);
        		return;
        	}         	
        });    
