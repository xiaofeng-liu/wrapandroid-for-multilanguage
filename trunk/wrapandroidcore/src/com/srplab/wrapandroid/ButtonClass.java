...
public class ButtonClass{
	...
	static public boolean Init(StarServiceClass In_Service,StarSrvGroupClass In_SrvGroup,boolean In_DumpInformationFlag){
		...
		WrapAndroidClass.DumpInformation(SrvGroup, DumpInformationFlag, "init ButtonClass");

		class StarCLEButton extends Button implements BasicAndroidInterface{
			private BasicAndroidClass BasicAndroidObject; 
			private List<Object> RefList;
			public StarCLEButton(Context ctx,StarObjectClass In_Object){
				super(ctx);
			...
			public void SetAndroidObject(Object object){SrvGroup._PrintError(1, "ButtonClass not support SetAndroidObject" );}
