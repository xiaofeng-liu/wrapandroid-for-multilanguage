...
public class EditTextClass{
	...
	static public boolean Init(StarServiceClass In_Service,StarSrvGroupClass In_SrvGroup,boolean In_DumpInformationFlag){
		...
		WrapAndroidClass.DumpInformation(SrvGroup, DumpInformationFlag, "init EditTextClass");
		
		class StarCLEEditText extends EditText implements BasicAndroidInterface{
			private BasicAndroidClass BasicAndroidObject; 
			private List<Object> RefList;
			public StarCLEEditText(Context ctx,StarObjectClass In_Object){
				super(ctx);
			...
			public void SetAndroidObject(Object object){SrvGroup._PrintError(1, "EditTextClass not support SetAndroidObject" );}
        ...
        Service._GetObject("EditTextClass")._Assign(new StarObjectClass(){
        	...
        	public void onCreateAndroid( StarObjectClass self ){
        		...
        		StarCLEEditText edittext = new StarCLEEditText((Activity)WrapAndroidClass.GetAndroidObject(activity,"AndroidObject"),self);
        		WrapAndroidClass.SetAndroidObject(self,"AndroidObject",(Object)edittext);
        		if( parent != null ){
        			if( activity == parent ){
