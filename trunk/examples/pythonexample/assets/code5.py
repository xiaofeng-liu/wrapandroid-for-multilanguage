...
def MyMediaPlayer_onPrepared(self, Ev) :
    print(self," event onPrepared is trigger ");
    return;
MyMediaPlayer.onPrepared = MyMediaPlayer_onPrepared
def MyMediaPlayer_onCompletion(self, Ev) :
    print(self," event onCompletion is trigger");
    return;
MyMediaPlayer.onCompletion = MyMediaPlayer_onCompletion;      	
